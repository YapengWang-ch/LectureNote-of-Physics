...
\newglossaryentry{Laguerre_Polynomial}{
    name = {Laguerre多项式},
    description = {Laguerre多项式是数学中一类特殊的正交多项式，常用于解决量子力学中的径向方程，特别是在氢原子问题中。它们满足特定的微分方程，并且在物理学中具有重要的应用。},
    first = {Laguerre多项式（Laguerre Polynomial）}
}
\newglossaryentry{GreenFunction}{
    name={Green函数},
    description={Green函数}
}

\newglossaryentry{LSEquation}{
    name={Lippman-Schwinger 方程},
    description={Lippman-Schwinger 方程}
}